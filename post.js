    ...
    "translated_segments":  [
{
   ...
   },
   {
      ...
      "target":"La pompe est destinée à être utilisée par des personnes âgées de six ans et plus."
   },
   {
      "source":"The pump is intended for single patient use.",
      "target":"Le système est conçu pour un usage individuel."
   },
   {
      "source":"The pump is indicated for use with NovoRapid or Humalog U-100 insulin.",
      "target":"La pompe est destinée à être utilisée avec l’insuline NovoRapid ou Humalog U-100."
   },
   {
   ...
   {
      "source":"Control-IQ technology is intended for the management of Type 1 diabetes mellitus in persons six years of age and greater.",
      "target":"La technologie Control-IQ est conçue pour la prise en charge du diabète de type 1 chez les personnes âgées d’au moins six ans."
   },
   {
      "source":"Control-IQ technology is intended for single patient use.",
      "target":"La technologie Control-IQ est conçue pour un usage individuel."
   },
   {
      "source":"Control-IQ technology is indicated for use with NovoRapid or Humalog U-100 insulin.",
      "target":"La technologie Control-IQ est destinée à être utilisée avec l’insuline NovoRapid ou Humalog U-100."
   },
   {
      "source":"",
      "target":""
   ...
   },
   {
      ...
      "target":"Ne commencez PAS à utiliser votre pompe avant d’avoir lu le guide d’utilisation. Le non-respect des instructions du guide d’utilisation peut entraîner une administration d’insuline excessive ou insuffisante. Cela pourrait provoquer des événements d’hypoglycémie (glycémie basse) ou d’hyperglycémie (glycémie élevée). Si vous avez des questions ou besoin de clarification supplémentaire concernant l’utilisation de votre pompe, demandez à votre professionnel de santé ou contactez l’assistance technique client."
   },
   {
      ...
      "target":"N’utilisez PAS votre pompe avant d’avoir été correctement formé à son utilisation par un formateur certifié ou d’avoir consulté les documents de formation disponibles en ligne si vous mettez à jour votre pompe. Contactez votre professionnel de santé pour déterminer vos besoins personnels en matière de formation pour la pompe. L’absence de formation adéquate quant à l’utilisation de votre pompe peut entraîner de graves blessures ou la mort."
   },
   {
   ...
   },
   {
      ...
      "target":"Ne placez AUCUNE autre substance ni AUCUN autre médicament dans la pompe. La pompe a été uniquement testée pour la perfusion sous-cutanée continue d’insuline (PSCI) U-100 Humalog ou U-100 NovoRapid. L’utilisation d’autres médicaments pourrait endommager la pompe et nuire à la santé en cas de perfusion."
   },
   {
   ...
   },
   {
      ...
      "target":"utiliser la pompe, la SGC et tous les autres composants du système conformément à leur mode d’emploi respectif;"
   },
   {
   ...
   },
   {
      ...
      "target":"consulter régulièrement le(s) professionnel(s) de santé."
   },
   {
   ...
   },
   {
      ...
      "target":"Utilisez UNIQUEMENT des réservoirs et des ensembles de perfusion avec des connecteurs adaptés et suivez le mode d’emploi. Faute de quoi, l’administration d’insuline pourrait être excessive ou insuffisante et entraîner une hypoglycémie (glycémie basse) ou une hyperglycémie (glycémie élevée)."
   },
   {
      ...
      "target":"Ne placez PAS votre ensemble de perfusion sur des cicatrices, des bosses, des grains de beauté, des vergetures ou des tatouages. Placer votre ensemble de perfusion sur de telles zones pourrait provoquer des gonflements, des irritations ou des infections. Cela peut nuire à l’absorption d’insuline et provoquer une hyperglycémie ou une hypoglycémie."
   },
   {
      ...
      "target":"Suivez TOUJOURS attentivement le mode d’emploi fourni avec votre ensemble de perfusion pour une insertion et des soins appropriés au site de perfusion, faute de quoi vous pourriez provoquer une administration excessive ou insuffisante d’insuline ou une infection."
   },
   {
   ...
   {
      "source":"There is no need to disconnect for electrocardiograms (EKGs) or colonoscopies. If you have questions, contact Customer Technical Support.",
      "target":"Il n’est pas nécessaire de débrancher le système pour les électrocardiogrammes (ECG) ou les coloscopies. Si vous avez des questions, contactez l’assistance technique client."
   },
   {
   ...
   {
      "source":"Magnetic Resonance Imaging Safety",
      "target":""
   },
   {
      "source":"The System is magnetic resonance (MR) unsafe. You must take off your pump, transmitter, and sensor and leave them outside the procedure room if you are going to have any of the following procedures:",
      "target":"Sécurité de l’imagerie par résonance magnétique"
   },
   {
      "source":"X-ray",
      "target":"Le système est incompatible avec la résonance magnétique (RM). Si vous devez subir l’une des procédures suivantes, vous devez retirer votre pompe, votre émetteur et votre capteur et les laisser hors de la salle d’opération."
   },
   {
      "source":"Computed Tomography (CT) scan",
      "target":"une radiographie (rayons X);"
   },
   {
      "source":"Magnetic Resonance Imaging (MRI)",
      "target":"un balayage tomodensitométrique (scanner);"
   },
   {
   ...
   },
   {
      ...
      "target":"N’exposez PAS votre pompe, votre émetteur ou votre capteur à :"
   },
   {
   ...
   },
   {
      ...
      "target":"Si vous devez subir l’une des procédures médicales ci-dessus, vous devez retirer votre pompe, votre émetteur et votre capteur et les laisser hors de la salle d’opération."
   },
   {
   ...
   },
   {
      ...
      "target":"N’ignorez PAS un bris de filament du capteur. Les capteurs peuvent se briser à de rares occasions. Si un filament de capteur se brise et qu’aucune partie n’est visible sur la peau, n’essayez pas de le retirer. Demandez une aide médicale professionnelle si vous constatez des symptômes d’infection ou d’inflammation (rougeurs, gonflements ou douleurs) au niveau du site d’insertion. Signalez toute rupture du filament du capteur au service d’’assistance technique client."
   },
   {
   ...
   },
   {
      ...
      "target":"N’utilisez PAS votre émetteur s’il est endommagé ou fissuré. Cela pourrait présenter un risque électrique pour la sécurité ou provoquer une défaillance, qui pourraient entraîner une électrocution."
   },
   {
   ...
   },
   {
      ...
      "target":"N’ouvrez PAS votre pompe à insuline et n’essayez PAS de la réparer. La pompe est un dispositif scellé qui ne doit être ouvert et réparé uniquement par Tandem Diabetes Care. Les modifications pourraient entraîner un danger pour la sécurité. Si le joint de votre pompe est cassé, celle-ci n’est plus étanche, et la garantie est annulée."
   },
   {
   ...
   },
   {
      ...
      "target":"VÉRIFIEZ quotidiennement que votre site de perfusion est bien placé et ne présente pas de fuite. REMPLACEZ votre ensemble de perfusion si vous observez des fuites autour du site. Les sites mal placés ou les fuites autour du site de perfusion peuvent entraîner une administration insuffisante d’insuline."
   },
   {
   ...
   },
   {
      ...
      "target":"VÉRIFIEZ quotidiennement la connexion de la tubulure entre la tubulure de votre réservoir et la tubulure de l’ensemble de perfusion pour vous assurer qu’elle est solide et sécurisée. Les fuites autour de la connexion de la tubulure peuvent entraîner une administration insuffisante d’insuline."
   },
   {
   ...
   },
   {
      ...
      "target":"VÉRIFIEZ les réglages de votre pompe régulièrement pour vous assurer qu’ils sont corrects. Des réglages incorrects peuvent entraîner une administration excessive ou insuffisante d’insuline. Consultez votre professionnel de santé si nécessaire."
   },
   {
   ...
   },
   {
      ...
      "target":"VÉRIFIEZ régulièrement si votre pompe affiche une condition d’alarme. Il est important de connaître les conditions qui peuvent nuire à l’administration d’insuline et nécessiter votre attention afin que vous puissiez réagir le plus rapidement possible."
   },
   {
      ...
      "target":"N’utilisez PAS le réglage Vibrer pour les alertes et les alarmes pendant votre sommeil, à moins que votre professionnel de santé vous l’indique. Régler un volume d’alertes et d’alarme élevé aide à vous assurer que vous ne manquez pas une alerte ou une alarme."
   },
   {
   ...
   },
   {
      ...
      "target":"DÉBRANCHEZ l’ensemble de perfusion de votre corps lorsque vous montez dans des manèges à sensation à haute vitesse/forte gravité. Les changements rapides d’altitude ou de gravité peuvent perturber l’administration d’insuline et provoquer des blessures."
   },
   {
   ...
   },
   {
      ...
      "target":"Une interférence avec les éléments électroniques de votre pompe peut être causée par les téléphones portables si vous les portez à proximité. Il est recommandé de porter votre pompe et votre téléphone portable à au moins 16,3 cm (6,4 po) d’écart."
   },
   {
      ...
      "target":"Jetez TOUJOURS les composants usagés tels que les réservoirs, les seringues, les aiguilles, les ensembles de perfusion et les capteurs SGC en suivant les instructions de votre professionnel de santé. Lavez-vous soigneusement les mains après avoir manipulé les composants usagés."
   },
   {
      "source":"",
      "target":""
   },
   {
      ...
      "target":"Utilisation du SGC Dexcom G6 avec votre pompe à insuline t:slim X2"
   },
   {
      ...
      "target":"N’ouvrez PAS l’emballage du capteur avant de vous être lavé les mains avec du savon et de l’eau et de les avoir laissé sécher. Vous pourriez contaminer le site d’insertion et souffrir d’une infection si vous avez les mains sales lors de l’insertion du capteur."
   },
   {
   ...
   },
   {
      ...
      "target":"ÉVITEZ d’insérer le capteur dans des régions susceptibles de subir des chocs, des pressions ou des compressions, ou sur des zones de la peau présentant des cicatrices, des tatouages ou des irritations : ce ne sont pas des sites optimaux pour mesurer le glucose. L’insertion dans ces zones pourrait nuire à la précision; à cause de cela, vous pourriez passer à côté d’une hypoglycémie (faible taux de glucose dans le sang) ou d’une hyperglycémie (taux élevé de glucose dans le sang) grave."
   },
   {
      ...
      "target":"ÉVITEZ d’injecter l’insuline ou de placer un ensemble de perfusion dans un rayon de 7,6 cm (3 po) autour du capteur. L’insuline pourrait nuire à la précision du capteur; à cause de cela, vous pourriez passer à côté d’une hypoglycémie (faible taux de glucose dans le sang) ou d’une hyperglycémie (taux élevé de glucose dans le sang) grave."
   },
   {
   ...
   },
   {
      ...
      "target":"FAITES ATTENTION aux informations de tendance affichées sur l’écran Accueil de votre SGC, ainsi qu’à vos symptômes, avant d’utiliser les valeurs de la SGC pour calculer et administrer un bolus de correction. Il est possible que des valeurs individuelles de la SGC ne soient pas aussi précises que les valeurs du glucomètre."
   },
   {
   ...
   },
   {
      ...
      "target":"La précision de la SGC Dexcom G6 peut être perturbée lorsque votre glucose change rapidement (c’est-à-dire de 0,1 à 0,2 mmol/L/min ou plus de 0,2 mmol/L chaque minute), par exemple pendant que vous faites du sport ou après un repas."
   },
   {
   ...
   },
   {
      ...
      "target":"VÉRIFIEZ que l’identifiant émetteur est programmé dans la pompe avant d’utiliser le système si vous recevez une pompe de remplacement dans le cadre de la garantie. La pompe ne peut pas communiquer avec l’émetteur si l’identifiant émetteur n’est pas saisi. Si la pompe et l’émetteur ne communiquent pas, vous ne recevez pas les lectures de glucose du capteur, et vous pourriez passer à côté d’une hypoglycémie (faible taux de glucose dans le sang) ou d’une hyperglycémie (taux élevé de glucose dans le sang) grave."
   },
   {
      ...
      "target":"Ne jetez PAS votre émetteur. Il est réutilisable. Le même émetteur est utilisé pour chaque session jusqu’à l’épuisement de sa batterie."
   },
   {
      ...
      "target":"Le capteur Dexcom G6 n’est pas compatible avec les anciennes versions d’émetteurs ou de récepteurs. Ne mélangez pas les émetteurs, les récepteurs et les capteurs de différentes générations."
   },
   {
   ...
   },
   {
      ...
      "target":"Vous avez la possibilité d’afficher diverses données directement sur votre écran, notamment l’heure et la quantité de votre dernier bolus, le total de votre administration d’insuline par jour, ainsi qu’une répartition par bolus basal, repas et de correction."
   },
   {
      "source":"",
      "target":""
   ...
   },
   {
      ...
      "target":"L’insertion et le port d’un ensemble de perfusion peuvent provoquer des infections, des saignements, des douleurs ou des irritations cutanées (rougeurs, gonflements, contusions, démangeaisons, cicatrices ou décoloration de la peau)."
   },
   {
      "source":"There is a remote chance that an infusion set cannula fragment could remain under your skin if the cannula breaks while you are wearing it. If you think a cannula has broken under your skin, contact your healthcare provider and call Customer Technical Support.",
      "target":"Il existe une faible probabilité qu’un fragment de la canule de l’ensemble de perfusion reste sous la peau si la canule se casse pendant que vous la portez. Si vous pensez qu’une canule s’est cassée sous votre peau, contactez votre professionnel de santé et appelez l’assistance technique client."
   },
   {
   ...
   {
      "source":"Inserting the sensor and wearing the adhesive patch might cause infection, bleeding, pain and skin irritations (redness, swelling, bruising, itching, scarring, or skin discoloration).",
   ...
   {
      "source":"There is a remote chance that a sensor wire fragment could remain under your skin if the sensor wire breaks while you are wearing it. If you think a sensor wire has broken under your skin, contact your healthcare provider and call Customer Technical Support.",
      "target":"Il existe une faible probabilité qu’un fragment du filament du capteur reste sous la peau si le filament du capteur se casse pendant que vous le portez. Si vous pensez qu’un filament de capteur s’est cassé sous votre peau, contactez votre professionnel de santé et appelez le service d’assistance client technique."
   },
   {
      "source":"Other risks associated with CGM use include the following:",
      "target":"Les autres risques associés à l’utilisation de la SGC sont les suivants :"
   },
   {
   ...
   },
   {
      ...
      "target":"Consultez votre professionnel de santé avant d’utiliser la pompe afin de déterminer les caractéristiques qui vous conviennent le mieux. Seul votre professionnel de santé peut déterminer et vous aider à régler votre (vos) débit(s) basal (basaux), votre (vos) ratio(s) de glucides, votre (vos) facteur(s) de correction, votre glycémie cible et la durée de l’action de l’insuline. Par ailleurs, seul votre professionnel de santé peut déterminer vos réglages SGC et la manière dont vous devez utiliser les informations de tendances de votre capteur pour vous aider à gérer votre diabète."
   },
   {
      "source":"",
      "target":""
   ...
   },
   {
      ...
      "target":"Assurez-vous de toujours disposer d’une seringue d’insuline et d’un flacon d’insuline ou d’un stylo à insuline prérempli comme solution de rechange en cas d’urgence. Vous devez également toujours avoir une trousse de secours appropriée avec vous. Parlez avec votre professionnel de la santé pour connaître les éléments que cette trousse doit contenir."
   },
   {
      "source":"Supplies to carry every day:",
      "target":"Fournitures à apporter tous les jours :"
   },
   {
      "source":"BG testing supplies: meter, strips, control solution, lancets, meter batteries",
      "target":"matériel pour tester la glycémie : glucomètre, bandelettes, solution de contrôle, lancette, piles pour le glucomètre;"
   },
   {
      "source":"Fast-acting carbohydrate to treat low BG",
      "target":"glucides rapides pour traiter l'hypoglycémie;"
   },
   {
   ...
   },
   {
      ...
      "target":"insuline rapide et seringues ou stylo à insuline prérempli;"
   },
   {
      "source":"Infusion sets (minimum of 2)",
      "target":"ensembles de perfusion (au moins 2) ;"
   },
   {
   ...
   },
   {
      ...
      "target":"produits de préparation du site de perfusion (lingettes antiseptiques, adhésif pour la peau) ;"
   },
   {
   ...
   },
   {
      ...
      "target":"Une alimentation électrique (adaptateur CA avec connecteur micro-USB) est incluse avec votre pompe. Avant d’utiliser votre pompe, vérifiez que les phénomènes suivants se produisent lorsque vous branchez une alimentation électrique au port USB de votre pompe :"
   },
   {
   ...
   },
   {
      ...
      "target":"vous voyez le témoin vert s’illuminer au bord du bouton Écran activé/Bolus rapide;"
   },
   {
   ...
   },
   {
      ...
      "target":"appuyez sur le bouton Écran activé/Bolus rapide pour activer l’écran afin de voir l’affichage;"
   },
   {
      "source":"When the display screen is on, the touchscreen responds to your finger tap",
      "target":"lorsque l’écran est activé, vérifiez que l’écran tactile réagit lorsque vous le touchez du doigt."
   },
   {
      "source":"/!\\ PRECAUTION",
      "target":"/!\\ PRÉCAUTION"
   ...
   },
   {
      ...
      "target":"Le système et les composants du système garantissent la sécurité des données grâce à des méthodes exclusives et assurent l’intégrité des données au moyen de processus de vérification des erreurs, notamment les contrôles cycliques de redondance."
   },
   {
      "source":"",
      "target":""
